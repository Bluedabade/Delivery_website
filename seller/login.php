        ...
        <div class="container">
            ...
            <div class="container">
                <div class="col-md-5">
                    ...
                    <form class="jumbotron" action="../seller_php/login.php" method="post">
                        <h2>เข้าสู่ระบบร้านอาหาร</h2><br>
                           ...
                           <a href="signup.php" type="submit" class="btn btn-block btn-primary">สมัครร้านอาหาร</a>
