    ...
    <center>
        <div class="container">
            ...
            <div class="container">
                <div class="col-md-5">
                <?php 
                    $sql = "SELECT * FROM `rider` WHERE ID = '".$_SESSION['rider_id']."'";
                    $result = $conn->query($sql);
                    $row = $result->fetch_assoc();
                    ?>
                    <form class="jumbotron" action="../rider_php/editprofile.php" method="post" enctype="multipart/form-data" >
                        <h2>แกไขข้อมูล</h2><br>
                        ...
                        <img src="../upload/<?php echo $row['img'] ?>" class="a" width="50px" height="50px" alt="" >
                        <br><br>
                        ...
                        <a onclick= "return confirm('ยืนยันการออกจากระบบ')" href="../rider_php/logout.php" class="btn btn-block btn-danger">ออกจากระบบ</a>
